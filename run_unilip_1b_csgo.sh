#!/bin/bash
export OUTPUT_FOLDER=outputs_csgo_1b
# export EDIT_IMG_FOLDER=../data/edit_sft
# export GEN_IMG_FOLDER=../data/gen_sft
export CSGO_IMG_FOLDER=data/preprocessed_data

# single node
# torchrun --nproc_per_node=4 --master_port=29506
# torchrun --nproc_per_node=1 --nnodes=$WORLD_SIZE --node_rank=$RANK --master_port=$MASTER_PORT --master_addr=$MASTER_ADDR \
CUDA_VISIBLE_DEVICES=1 python \
    ...
    # --gen_repeat 1 \
    # --edit_repeat 3 \
    \ --csgo_image_folder ${CSGO_IMG_FOLDER} \
