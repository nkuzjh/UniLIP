...
```    CUDA_VISIBLE_DEVICES=0 python eval_csgo.py --csgo_config csgo_configs/test/exp20_dust2_gen.yaml      ```
    **benchmark_csgo.py** 4000
    ``      CUDA_VISIBLE_DEVICES=0 python benchmark_csgo.py --gt data/preprocessed_data/de_dust2/imgs --pred outputs_eval/exp20_dust2_gen/test_20260426_185525/gen_imgs/de_dust2 --all --batch_size 8       ``
