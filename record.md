...
```    CUDA_VISIBLE_DEVICES=0 python eval_csgo.py --csgo_config csgo_configs/test/exp17_5_dust2_gen.yaml      ```
    **benchmark_csgo.py**
    ``      CUDA_VISIBLE_DEVICES=1 python benchmark_csgo.py --gt data/preprocessed_data/de_dust2/imgs --pred outputs_eval/exp17_5_dust2_gen/test_20260419_220732/gen_imgs/de_dust2 --all --batch_size 8       ``
...
```    CUDA_VISIBLE_DEVICES=1 python eval_csgo.py --csgo_config csgo_configs/test/exp17_5_dust2_gen_conti.yaml      ```
    **benchmark_csgo.py**
    ``      CUDA_VISIBLE_DEVICES=1 python benchmark_csgo.py --gt data/preprocessed_data/de_dust2/imgs --pred outputs_eval/exp17_5_dust2_gen_conti/test_20260419_220731/gen_imgs/de_dust2 --all --batch_size 8       ``
    **frames to video**
